const CACHE='estudos-v7-7';
const ASSETS=['./','./index.html','./manifest.json','./espc_facade_sepia.jpg','./espc_logo.png','./math.png','./physics.png','./chem.png','./history.png','./geo.png','./port.png','./eng.png','./icon-192.png','./icon-512.png'];
